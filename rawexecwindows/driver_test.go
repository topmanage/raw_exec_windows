...
func newEnabledRawexecwindowsDriver(t *testing.T) *Driver {
	ctx, cancel := context.WithCancel(context.Background())
	t.Cleanup(cancel)

	logger := testlog.HCLogger(t)
	d := NewRawExecWindowsDriver(ctx, logger).(*Driver)
...
func TestRawexecwindowsDriver_SetConfig(t *testing.T) {
	ci.Parallel(t)
	...
	d := NewRawExecWindowsDriver(ctx, logger)
...
func TestRawexecwindowsDriver_Fingerprint(t *testing.T) {
	ci.Parallel(t)

	fingerprintTest := func(config *Config, expected *drivers.Fingerprint) func(t *testing.T) {
		return func(t *testing.T) {
			require := require.New(t)
			d := newEnabledRawexecwindowsDriver(t)
			harness := dtestutil.NewDriverHarness(t, d)
			defer harness.Kill()
	...
	cases := []struct {
		...
		},
		{
			...
			Expected: drivers.Fingerprint{
				Attributes:        map[string]*pstructs.Attribute{"driver.rawexecwindows": pstructs.NewBoolAttribute(true)},
...
func TestRawexecwindowsDriver_StartWait(t *testing.T) {
	ci.Parallel(t)
	require := require.New(t)
...
func TestRawexecwindowsDriver_StartWaitRecoverWaitStop(t *testing.T) {
	ci.Parallel(t)
	require := require.New(t)
...
func TestRawexecwindowsDriver_Start_Wait_AllocDir(t *testing.T) {
	ci.Parallel(t)
	require := require.New(t)
...
func TestRawexecwindowsDriver_Start_Kill_Wait_Cgroup(t *testing.T) {
	ci.Parallel(t)
...
func TestRawexecwindowsDriver_ParentCgroup(t *testing.T) {
...
func TestRawexecwindowsDriver_Exec(t *testing.T) {
	ci.Parallel(t)
	ctestutil.ExecCompatible(t)
...
func TestRawexecwindowsDriver_Disabled(t *testing.T) {
	ci.Parallel(t)
	require := require.New(t)
